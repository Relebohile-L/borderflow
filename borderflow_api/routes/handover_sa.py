...
handover_sa_bp = Blueprint("handover_sa", __name__)

# GET all handovers
@handover_sa_bp.route("/handovers", methods=["GET"])
def get_handovers():
    db = get_db()
...
# GET by ID
@handover_sa_bp.route("/handovers/<int:handover_id>", methods=["GET"])
...
@handover_sa_bp.route("/handovers", methods=["POST"])
def create_handover():
    data = request.json
    db = get_db()
    cursor = db.cursor(dictionary=True)
...
# PUT update
@handover_sa_bp.route("/handovers/<int:handover_id>", methods=["PUT"])
...
# DELETE
@handover_sa_bp.route("/handovers/<int:handover_id>", methods=["DELETE"])
