...
clearance_mru_bp = Blueprint("clearance_mru", __name__)

@clearance_mru_bp.route("/clearances", methods=["GET"])
def get_clearances():
    db = get_db()
...
@clearance_mru_bp.route("/clearances/<int:clearance_id>", methods=["GET"])
...
@clearance_mru_bp.route("/clearances", methods=["POST"])
...
@clearance_mru_bp.route("/clearances/<int:clearance_id>", methods=["PUT"])
...
@clearance_mru_bp.route("/clearances/<int:clearance_id>", methods=["DELETE"])
