...
handover_mru_bp = Blueprint("handover_mru", __name__)

@handover_mru_bp.route("/handovers", methods=["GET"])
def get_handovers():
    db = get_db()
...
@handover_mru_bp.route("/handovers/<int:handover_id>", methods=["GET"])
...
@handover_mru_bp.route("/handovers", methods=["POST"])
def create_handover():
    data = request.json
    db = get_db()
    cursor = db.cursor(dictionary=True)
...
@handover_mru_bp.route("/handovers/<int:handover_id>", methods=["PUT"])
...
@handover_mru_bp.route("/handovers/<int:handover_id>", methods=["DELETE"])
