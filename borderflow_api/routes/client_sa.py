...
client_sa_bp = Blueprint("client_sa", __name__)

# GET all clients
@client_sa_bp.route("/clients", methods=["GET"])
def get_clients():
    db = get_db()
...
# GET client by ID
@client_sa_bp.route("/clients/<int:client_id>", methods=["GET"])
...
# POST create client
@client_sa_bp.route("/clients", methods=["POST"])
def create_client():
    data = request.json
    db = get_db()
    cursor = db.cursor(dictionary=True)
...
# PUT update client
@client_sa_bp.route("/clients/<int:client_id>", methods=["PUT"])
...
# DELETE client
@client_sa_bp.route("/clients/<int:client_id>", methods=["DELETE"])
